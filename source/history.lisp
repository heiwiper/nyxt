...
(defmethod prompter:object-attributes ((entry history-entry) (source prompt-buffer-source))
...
(define-class history-disowned-source (prompt-buffer-source)
...
(define-class history-name-source (prompt-buffer-source)
