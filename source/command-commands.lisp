...
(define-class command-source (prompt-buffer-source)
...
(define-class predicted-command-source (prompt-buffer-source)
...
(defmethod prompter:object-attributes ((command command) (source prompt-buffer-source))
  (declare (ignore source))
  (command-attributes command))

(define-class extended-command-source (prompt-buffer-source)
...
(define-class hook-source (prompt-buffer-source)
  ((prompter:name "Hooks")
...
(define-class handler-source (prompt-buffer-source)
