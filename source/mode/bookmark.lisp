...
(defmethod prompter:object-attributes ((entry bookmark-entry) (source prompt-buffer-source))
...
(define-class bookmark-source (prompt-buffer-source)
...
(define-class tag-source (prompt-buffer-source)
  ((prompter:name "Tags")
