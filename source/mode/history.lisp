...
(define-class history-backwards-source (prompt-buffer-source)
...
(defmethod prompter:object-attributes ((node history-tree:node) (source prompt-buffer-source))
...
(define-class direct-history-forwards-source (prompt-buffer-source)
...
(define-class history-forwards-source (prompt-buffer-source)
...
(define-class all-history-forwards-source (prompt-buffer-source)
...
(define-class history-all-owner-nodes-source (prompt-buffer-source)
...
(define-class history-all-source (prompt-buffer-source)
  ((prompter:name "All history URLs")
   (buffer :initarg :buffer :accessor buffer :initform nil)
   (prompter:constructor
    (lambda (source)
