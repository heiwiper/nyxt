...
(define-class program-source (prompt-buffer-source)
...
(defmethod prompter:object-attributes ((path pathname) (source prompt-buffer-source))
...
(define-class file-source (prompt-buffer-source)
  ((prompter:name "Files")
