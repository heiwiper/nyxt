...
(define-class describe-nyxt-source (prompt-buffer-source)
  ((visibility
    :any
...
(defmethod prompter:object-attributes ((symbol symbol) (source prompt-buffer-source))
...
(defmethod prompter:object-attributes ((package package) (source prompt-buffer-source))
  (declare (ignore source))
...
(define-class package-source (prompt-buffer-source)
