...
\(prompt :prompt \"Test prompt\"
         :sources (make-instance 'prompt-buffer-source
                                 :name \"Test\"
                                 :constructor '(\"foo\" \"bar\")))
...
(define-class resume-prompt-source (prompt-buffer-source)
...
(defmethod prompter:object-attributes ((prompt-buffer prompt-buffer) (source prompt-buffer-source))
